...
class GoogleMapsWidgetState extends State<GoogleMapsWidget> {
  ...
  void initState() {
    super.initState();
    maps =
        '<html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Document</title></head><body><iframe width="100%" height="100%" style="border:0" loading="lazy" allowfullscreen src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCXHxN1Jd-3wYZUrPq0zIRe-t52puaGR2U&q=$address"></iframe></body></html>';
